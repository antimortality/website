export const prevention = [
  {
    ...
    problems: [
      ...
      {
        text: "Reduce toxicity of cryoprotectants",
        completed: false,
        projects: [
          {
            name: "21st Century Medicine",
...
export const ascension = [
  {
    title: "Human Enhancements",
    description: "Upgrade human body with augmentations",
    icon: "fas fa-running",
    problems: [
      {
