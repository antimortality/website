...
const Index = () => {
  ...
  return (
    <div className="outer">
      ...
      <Tree />
      <p className="footer">Copyright &copy; 2022 Antimortality; a project by <a href="https://twitter.com/kaimicahmills" target="_blank" rel="noreferrer">@kaimicahmills</a></p>
    </div>
  );
};
